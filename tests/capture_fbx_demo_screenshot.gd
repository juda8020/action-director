...
func _capture() -> void:
	...
	app._on_event_selected(app._find_event("3d-a-hitbox"), "3d-a-hitbox-track")
	app._set_tick(35)
	app._set_status("Take B reaches contact 5 ticks sooner with a longer forward charge.")
